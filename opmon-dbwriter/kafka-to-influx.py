...
@click.option(
    "--kafka-port", type=click.INT, default=30092, help="port of the kafka broker"
)
@click.option(
    "--kafka-topics",
    multiple=True,
...
@click.option(
    ...
    type=click.INT,
    default=1000,
    help="batch sizes in ms to send data to influx",
)
@click.option(
    "--batch_size",
    type=click.INT,
    default=1000,
    help="batch sizes to send data to influx",
)
@click.option(
    "--influxdb-address",
    type=click.STRING,
    default="opmondb.cern.ch",
